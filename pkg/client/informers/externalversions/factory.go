...
import (
	...
	boos "github.com/mattmoor/boo-maps/pkg/client/informers/externalversions/boos"
...
func (f *sharedInformerFactory) Boos() boos.Interface {
	return boos.New(f, f.namespace, f.tweakListOptions)
}
